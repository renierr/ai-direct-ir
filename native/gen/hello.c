...
static void w2c_hello_0x5Fstart_0(w2c_hello*);

FUNC_TYPE_T(w2c_hello_t0) = "\xf6\x98\x1b\xc6\x10\xda\xb7\xb2\x63\x37\xcd\xdc\x72\xca\xe9\x50\x00\x13\xba\x10\x6c\xde\x87\x27\x10\xf8\x86\x2f\xe3\xdb\x94\xe4";
FUNC_TYPE_T(w2c_hello_t1) = "\x36\xa9\xe7\xf1\xc9\x5b\x82\xff\xb9\x97\x43\xe0\xc5\xc4\xce\x95\xd8\x3c\x9a\x43\x0a\xac\x59\xf8\x4e\xf3\xcb\xfa\xb6\x14\x50\x68";

static const u8 data_segment_data_w2c_hello_d0[] = {
  0x68, 0x65, 0x6c, 0x6c, 0x6f, 0x20, 0x66, 0x72, 0x6f, 0x6d, 0x20, 0x41, 
  0x49, 0x2d, 0x64, 0x69, 0x72, 0x65, 0x63, 0x74, 0x20, 0x49, 0x52, 0x0a, 
  
};

static void init_memories(w2c_hello* instance) {
  wasm_rt_allocate_memory(&instance->w2c_memory, 1, 65536, 0, 65536);
  LOAD_DATA(instance->w2c_memory, 8u, data_segment_data_w2c_hello_d0, 24);
}

static void init_data_instances(w2c_hello *instance) {
}
...
/* export: '_start' */
void w2c_hello_0x5Fstart(w2c_hello* instance) {
#if WASM_RT_USE_SEGUE_FOR_THIS_MODULE
#if !WASM_RT_SEGUE_FREE_SEGMENT
...
#endif
  w2c_hello_0x5Fstart_0(instance);
#if WASM_RT_USE_SEGUE_FOR_THIS_MODULE && !WASM_RT_SEGUE_FREE_SEGMENT
  wasm_rt_segue_write_base(segue_saved_base);
#endif
}

static void init_instance_import(w2c_hello* instance, struct w2c_wasi__snapshot__preview1* w2c_wasi__snapshot__preview1_instance) {
  instance->w2c_wasi__snapshot__preview1_instance = w2c_wasi__snapshot__preview1_instance;
}

void wasm2c_hello_instantiate(w2c_hello* instance, struct w2c_wasi__snapshot__preview1* w2c_wasi__snapshot__preview1_instance) {
...
void wasm2c_hello_free(w2c_hello* instance) {
...
void w2c_hello_0x5Fstart_0(w2c_hello* instance) {
  FUNC_PROLOGUE;
