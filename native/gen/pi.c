...
static void w2c_pi_f3(w2c_pi*, u32, u32, u32);
static u32 w2c_pi_f4(w2c_pi*, u32, u32);
static u32 w2c_pi_f5(w2c_pi*, u32, u32);
static void w2c_pi_f6(w2c_pi*, u32);
static void w2c_pi_f7(w2c_pi*, u32);
static void w2c_pi_0x5Fstart_0(w2c_pi*);

FUNC_TYPE_T(w2c_pi_t0) = "\xf6\x98\x1b\xc6\x10\xda\xb7\xb2\x63\x37\xcd\xdc\x72\xca\xe9\x50\x00\x13\xba\x10\x6c\xde\x87\x27\x10\xf8\x86\x2f\xe3\xdb\x94\xe4";
FUNC_TYPE_T(w2c_pi_t1) = "\x89\x3a\x3d\x2c\x8f\x4d\x7f\x6d\x6c\x9d\x62\x67\x29\xaf\x3d\x44\x39\x8e\xc3\xf3\xe8\x51\xc1\x99\xb9\xdd\x9f\xd5\x3d\x1f\xd3\xe4";
FUNC_TYPE_T(w2c_pi_t2) = "\x78\xde\x71\xb6\x49\x9a\x33\x9d\xd3\x70\x88\x4c\x50\xd4\xea\xdf\xe1\x2a\x18\x12\xf6\xf3\x64\xf7\xea\x4f\x94\x19\xa7\x20\x28\xe8";
FUNC_TYPE_T(w2c_pi_t3) = "\x92\xfb\x6a\xdf\x49\x07\x0a\x83\xbe\x08\x02\x68\xcd\xf6\x95\x27\x4a\xc2\xf3\xe5\xe4\x7d\x29\x49\xe8\xed\x42\x92\x6a\x9d\xda\xf0";
FUNC_TYPE_T(w2c_pi_t4) = "\x36\xa9\xe7\xf1\xc9\x5b\x82\xff\xb9\x97\x43\xe0\xc5\xc4\xce\x95\xd8\x3c\x9a\x43\x0a\xac\x59\xf8\x4e\xf3\xcb\xfa\xb6\x14\x50\x68";

static void init_globals(w2c_pi* instance) {
  instance->w2c_g0 = 0u;
}

static const u8 data_segment_data_w2c_pi_d0[] = {
  0x45, 0x6e, 0x74, 0x65, 0x72, 0x20, 0x64, 0x69, 0x67, 0x69, 0x74, 0x73, 
  0x20, 0x28, 0x30, 0x2d, 0x31, 0x30, 0x30, 0x30, 0x29, 0x3a, 0x20, 
};

static const u8 data_segment_data_w2c_pi_d1[] = {
  0x49, 0x6e, 0x76, 0x61, 0x6c, 0x69, 0x64, 0x20, 0x69, 0x6e, 0x70, 0x75, 
  0x74, 0x3a, 0x20, 0x65, 0x6e, 0x74, 0x65, 0x72, 0x20, 0x61, 0x20, 0x6e, 
  0x75, 0x6d, 0x62, 0x65, 0x72, 0x20, 0x30, 0x2d, 0x31, 0x30, 0x30, 0x30, 
  0x0a, 
};

static const u8 data_segment_data_w2c_pi_d2[] = {
  0x33, 0x0a, 
};

static void init_memories(w2c_pi* instance) {
  wasm_rt_allocate_memory(&instance->w2c_memory, 2, 65536, 0, 65536);
  LOAD_DATA(instance->w2c_memory, 1024u, data_segment_data_w2c_pi_d0, 23);
  LOAD_DATA(instance->w2c_memory, 1088u, data_segment_data_w2c_pi_d1, 37);
  LOAD_DATA(instance->w2c_memory, 1200u, data_segment_data_w2c_pi_d2, 2);
}

static void init_data_instances(w2c_pi *instance) {
}
...
/* export: '_start' */
void w2c_pi_0x5Fstart(w2c_pi* instance) {
#if WASM_RT_USE_SEGUE_FOR_THIS_MODULE
#if !WASM_RT_SEGUE_FREE_SEGMENT
...
#endif
  w2c_pi_0x5Fstart_0(instance);
#if WASM_RT_USE_SEGUE_FOR_THIS_MODULE && !WASM_RT_SEGUE_FREE_SEGMENT
  wasm_rt_segue_write_base(segue_saved_base);
#endif
}

static void init_instance_import(w2c_pi* instance, struct w2c_wasi__snapshot__preview1* w2c_wasi__snapshot__preview1_instance) {
  instance->w2c_wasi__snapshot__preview1_instance = w2c_wasi__snapshot__preview1_instance;
}

void wasm2c_pi_instantiate(w2c_pi* instance, struct w2c_wasi__snapshot__preview1* w2c_wasi__snapshot__preview1_instance) {
...
void wasm2c_pi_free(w2c_pi* instance) {
...
void w2c_pi_f3(w2c_pi* instance, u32 var_p0, u32 var_p1, u32 var_p2) {
  FUNC_PROLOGUE;
...
u32 w2c_pi_f4(w2c_pi* instance, u32 var_p0, u32 var_p1) {
  FUNC_PROLOGUE;
  u32 var_i0, var_i1, var_i2, var_i3;
  var_i0 = 0u;
  var_i1 = var_p0;
...
u32 w2c_pi_f5(w2c_pi* instance, u32 var_p0, u32 var_p1) {
...
void w2c_pi_f6(w2c_pi* instance, u32 var_p0) {
  FUNC_PROLOGUE;
...
void w2c_pi_f7(w2c_pi* instance, u32 var_p0) {
...
void w2c_pi_0x5Fstart_0(w2c_pi* instance) {
  ...
  var_i1 = 1024u;
  var_i2 = 23u;
  w2c_pi_f3(instance, var_i0, var_i1, var_i2);
  var_i0 = 64u;
  var_i1 = 64u;
  var_i0 = w2c_pi_f4(instance, var_i0, var_i1);
  var_l0 = var_i0;
  var_i0 = var_l0;
  var_i0 = !(var_i0);
  if (var_i0) {
  ...
  var_i0 = 64u;
  var_i1 = var_l0;
  var_i0 = w2c_pi_f5(instance, var_i0, var_i1);
  var_l1 = var_i0;
  var_i0 = var_l1;
  var_i1 = 0u;
